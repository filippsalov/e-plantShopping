        ...
        <div className="product-card" key={plantIndex}>
         ...
         <button
                  className={`product-button ${
                    disabledProducts.includes(plant.name) ? 'disabled' : ''
                  }`} 
                  style={{
                    backgroundColor: `${disabledProducts.includes(plant.name) ? 'gray' : ''}`
                  }}
                  onClick={() => handleAddToCart(plant)}
                  disabled={disabledProducts.includes(plant.name)}
                >
                  {disabledProducts.includes(plant.name) ? 'Added' : 'Add'} to
                  Cart
                </button>
                        </div>
      ))}
